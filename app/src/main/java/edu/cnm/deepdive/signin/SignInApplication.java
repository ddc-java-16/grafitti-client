...
/**
 * Initializes (in the {@link #onCreate()} method) application-level resources that require static
 * (or singleton) initialization. This class <strong>must</strong> be referenced in
